return {
    ...
    config = function()
        ...
        keyset("n", "<leader>lgd", "<Plug>(coc-definition)", { silent = true, desc = "definition" })
        keyset("n", "<leader>lgD", "<Plug>(coc-type-definition)", { silent = true, desc = "type definition" })
        keyset("n", "<leader>lgi", "<Plug>(coc-implementation)", { silent = true, desc = "implementation" })
        keyset("n", "<leader>lgr", "<Plug>(coc-references)", { silent = true, desc = "reference" })
